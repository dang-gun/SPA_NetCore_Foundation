...
namespace SPA_NetCore_Foundation08.Migrations
{
    ...
    [Migration("20201006211018_Board_DefultDataAdd")]
    partial class Board_DefultDataAdd
    {
        /// <summary>
        /// 
        /// </summary>
            ...
            modelBuilder.Entity("ModelDB.Board", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoardFaculty = 0,
                            BoardState = 1,
                            CreateDate = new DateTime(2020, 10, 7, 6, 10, 17, 564, DateTimeKind.Local).AddTicks(2133),
                            Memo = "테스트용 게시판",
                            ShowCount = (short)0,
                            Title = "Test",
                            idBoardGroup = 0L
            ...
            modelBuilder.Entity("ModelDB.BoardPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ViewCount = 0L,
                            ViewCountNone = 0L,
                            WriteDate = new DateTime(2020, 10, 7, 6, 10, 17, 565, DateTimeKind.Local).AddTicks(5182),
                            idBoard = 1L,
                            idBoardCategory = 0L,
                            idUser = 1L,
