...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelDB.Board", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoardFaculty = 1,
                            BoardState = 1,
                            CreateDate = new DateTime(2021, 8, 29, 5, 4, 10, 260, DateTimeKind.Local).AddTicks(9466),
                            Memo = "테스트용 게시판",
                            ShowCount = (short)10,
                            Title = "Test",
                            idBoardGroup = 0L
            ...
            modelBuilder.Entity("ModelDB.BoardPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ViewCount = 0L,
                            ViewCountNone = 0L,
                            WriteDate = new DateTime(2021, 8, 29, 5, 4, 10, 261, DateTimeKind.Local).AddTicks(9468),
                            idBoard = 1L,
                            idBoardCategory = 0L,
                            idUser = 1L
                        });
            ...
            modelBuilder.Entity("ModelDB.UserSignInTokenLog", b =>
                {
                    b.Property<long>("idUserSignInTokenLog")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("idUserSignInTokenLog");

                    b.ToTable("UserSignInTokenLog");
                });
